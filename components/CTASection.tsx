    ...
    return (
        ...
        >
            ...
            <div className="max-w-3xl mx-auto px-5 sm:px-8 relative z-10 space-y-6">
                <div
                    className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mx-auto text-amauta-orange border border-white/10 shadow-sm animate-bounce-gentle">
