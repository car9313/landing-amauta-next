  ...
  return (
    <footer className="bg-amauta-blue-dark text-white border-t border-amauta-blue-dark relative overflow-hidden z-10 font-sans pb-20 md:pb-0">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-12 sm:py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center border-b border-amauta-slate-800 pb-10">
          ...
          <div className="md:col-span-5 space-y-4 text-center md:text-left">
            ...
            <p className="text-base text-amauta-orange-light">
              {t("footer:tagline")}
            </p>
          ...
          {/* Contact Details */}
          <div className="md:col-span-5 space-y-3.5 text-amauta-slate-400 font-semibold text-xs sm:text-sm leading-relaxed">
        ...
        <div className="pt-8 flex flex-col sm:flex-row gap-4 items-center justify-between text-xs font-semibold text-amauta-slate-500">
          <div>
      ...
      {activeModal && (
        <div className="fixed inset-0 bg-amauta-slate-900/70 backdrop-blur-sm z-55 flex items-center justify-center p-4">
          <div className="bg-white text-amauta-slate-900 rounded-2xl p-6 max-w-md w-full border border-amauta-slate-100 shadow-xl space-y-5">
            ...
            <div className="text-xs text-amauta-slate-600 font-semibold space-y-3 leading-relaxed max-h-60 overflow-y-auto">
              {activeModal === "privacy" ? (
                <>
