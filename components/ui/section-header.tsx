...
export function SectionHeader({ badge, title, description }: SectionHeaderProps) {
  ...
  return (
    <div className="mx-auto mb-16 max-w-2xl text-center">
      ...
      <h2 className="mt-5 text-3xl font-black tracking-tight text-amauta-blue-dark sm:text-4xl lg:text-5xl">
        {title}
      </h2>
      <p className="mt-4 text-base font-semibold leading-relaxed text-amauta-slate-700 sm:text-lg">
        {description}
      </p>
    </div>
  );
