...
export default function HowItWorks() {
  ...
  return (
      <section
          ref={containerRef}
          id="como-funciona"
          className="relative bg-[#FAF9F6] h-[280vh] lg:h-[var(--section-scroll-height)]"
      ...
      >
        ...
        {/* ── Sticky wrapper ── */}
        <div className="sticky top-[76px] flex flex-col justify-center py-4 lg:py-0 min-h-[calc(100vh-76px)] lg:min-h-screen">
          <div className="relative z-10 mx-auto max-w-7xl w-full px-5 sm:px-8 [--card-height:320px] lg:[--card-height:360px]">
            ...
            <div className="hidden lg:grid grid-cols-2 gap-16 mt-10 items-center">
              ...
              >
                {/* Fade superior */}
                <div className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-b from-[#FAF9F6] to-transparent z-10 pointer-events-none" />
